...
![Tests](https://img.shields.io/badge/Tests-64%20passing-brightgreen?style=for-the-badge&logo=vitest)
...
**64 项测试，重点是不变量而非快照值**——把今天的输出钉死成断言，会让明天的重构寸步难行：
